...
void st7789_init(void)
{
    ...
    // lcd_init_cmd_t my_st7789_init_cmds[] = {
    //     {0x36, {0x00}, 1},
    //     {0x3A, {0x05}, 1},
    ...
    //     {ST7789_CASET, {0x00, 0x00, 0x00, 0xf0}, 4},
    //     {ST7789_RASET, {0x00, 0x00, 0x00, 0xf0}, 4},
    //     {0x21, {0}, 0x80},
    //     {ST7789_SLPOUT, {0}, 0x80},
    //     {ST7789_DISPON, {0}, 0x80},
    //     {0, {0}, 0xff},
...
static void st7789_send_cmd(uint8_t cmd)
{
    ...
    WRITE_PERI_REG(GPIO_OUT_W1TC_REG, (0x1 << ST7789_DC));
...
static void st7789_send_data(void *data, uint16_t length)
{
    ...
    WRITE_PERI_REG(GPIO_OUT_W1TS_REG, (0x1 << ST7789_DC));
